...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_VIEW_HIDDEN, &CMainFrame::OnViewHidden)
	ON_COMMAND(ID_EDIT_SEARCH, &CMainFrame::OnEditSearch)
	ON_COMMAND(ID_EDIT_OPEN, &CMainFrame::OnEditOpen)
END_MESSAGE_MAP()
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	lstBasicCommands.AddTail(ID_EDIT_SEARCH);
	...
	lstBasicCommands.AddTail(ID_VIEW_HIDDEN);
...
{
	// TODO: Add your command handler cod
	MessageBox(_T("under construction"));
}


void CMainFrame::OnEditOpen()
{
	// TODO: Add your command handler code here
}
